...
//        static public String MAINurl="http://dev.leadmastercrm.com";//    development
    //    static public String MAINurl="http://qa.leadmastercrm.com";// production testing
    static public String MAINurl="https://app.leadmastercrm.com"; //production


    public void setPreferences(Context context, String key, String value) {

        SharedPreferences.Editor editor = context.getSharedPreferences("LeadMaster_Pref", Context.MODE_PRIVATE).edit();
...
//        editor5.commit();
    ...
    public  String getPreferences(Context context, String key) {
        ...
        SharedPreferences prefs = context.getSharedPreferences("LeadMaster_Pref", Context.MODE_PRIVATE);
...
//        String url="http://api.leadmaster.com/lmservice/lmservice_mobile.asmx";
        String url="http://api.leadmaster.com/lmservice/lmservice_mobile_beta.asmx";
//        String url="http://api.leadmaster.com/lmservice/lmservice_mobile_beta_vijay.asmx";
        return url;
    }
...
//        String mainUrl="http://app.leadmastercrm.com";
    }
