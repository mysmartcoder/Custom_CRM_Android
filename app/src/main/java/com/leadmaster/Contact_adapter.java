...
public class Contact_adapter extends BaseAdapter {
    ...
    public Contact_adapter(Context context, ArrayList myList, int i, int j) {
        this.myList = myList;
    ...
    @Override
    public Contact_Data getItem(int position) {
        return (Contact_Data) myList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.raw_contacts, parent, false);
        ...
        if(manager.getFontStyle(context).equals("open-sans"))
        {
            ...
            CustomFont.markAsIconContainer(convertView.findViewById(R.id.conAdp_parent), mainFont);
        }
        ...
        FontManager.markAsIconContainer(convertView.findViewById(R.id.icons_container), iconFont);

        final Contact_Data currentListData = getItem(position);
        ...
        mViewHolder.mail_Acc_btn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                bundle.putString("companyName", currentListData.getAcc());
...
//                        return;
    ...
    private class MyViewHolder
    {
        ...
        {
            tvEntered = (TextView) item.findViewById(R.id.cont_entered);
            tvContact = (TextView) item.findViewById(R.id.cont_contact);
            tvAcc = (TextView) item.findViewById(R.id.cont_acc);
            tvLead=(TextView) item.findViewById(R.id.cont_lead);
            tvCampaign=(TextView)item.findViewById(R.id.cont_camp);
            tvAccMgr=(TextView) item.findViewById(R.id.cont_act_mgr);
            tvPhone=(TextView)item.findViewById(R.id.cont_phone);
            tvRecord=(TextView)item.findViewById(R.id.cont_record_id);

            con_tvEntered = (TextView) item.findViewById(R.id.con_tventered);
            con_tvContact = (TextView) item.findViewById(R.id.con_tvcontact);
            con_tvAcc = (TextView) item.findViewById(R.id.con_tvaccount);
            con_tvLead=(TextView) item.findViewById(R.id.con_tvleadstatus);
            con_tvCampaign=(TextView)item.findViewById(R.id.con_tvcampaign);
            con_tvAccMgr=(TextView) item.findViewById(R.id.con_tvacctmgr);
            con_tvPhone=(TextView)item.findViewById(R.id.con_tvphone);

            mail_Acc_btn=(Button)item.findViewById(R.id.email_btn_Con);

            assign_cont_btn=(Button)item.findViewById(R.id.assign_btn_Cont);
            delete_cont_btn=(Button)item.findViewById(R.id.delete_btn_Cont);
            map_cont_btn=(Button)item.findViewById(R.id.map_btn_Cont);
            call_cont_btn=(Button)item.findViewById(R.id.call_btn_Cont);
            select_cont_btn=(Button)item.findViewById(R.id.select_btn_Cont);
        }
    }
