...
//                categories.add("DroidSerif-Regular");
                categories.add("LeadMasterCRM - Default");
                categories.add("LeadMasterCRM - Open-sans");
                categories.add("LeadMasterCRM - PT-sans");
                categories.add("LeadMasterCRM - Lora-Regular");
                categories.add("LeadMasterCRM - DroidSerif-Regular");
...
//                    FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
        ...
        change_rate_parent.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                String myUrl ="https://play.google.com/store/apps/details?id=com.leadmaster&hl=en";
        ...
        change_share_parent.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                try
                {
                    ...
                    String sAux = "\nLet me recommend you LeadMasterCRM android application : \n\n";
                    sAux = sAux + "https://play.google.com/store/apps/details?id=com.leadmaster&hl=en \n\n";
                    i.putExtra(Intent.EXTRA_TEXT, sAux);
                    startActivity(Intent.createChooser(i, "Share LeadMasterCRM"));
                }
                catch(Exception e) {
                    //e.toString();
                }
