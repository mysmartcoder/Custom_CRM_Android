...
public class AddContact_Dynamic extends AppCompatActivity 
{
    ProgressDialog pd;
...
//    HashMap<String,String> spinnerMap;
    ...
    TextView partitionName_textview_addContact,record_id_hidden_addContact,change_serach_result_addcontact;
    TextInputLayout accountSearchHint_addContact;
    ...
    protected void onCreate(Bundle savedInstanceState) 
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
            ...
            window.setStatusBarColor(manager.getStatusColor(AddContact_Dynamic.this));
        }

        if(manager.getFontStyle(AddContact_Dynamic.this).equals("open-sans"))
        {
            Log.e("font","1");
            Typeface mainFont = CustomFont.getTypeface(AddContact_Dynamic.this.getApplicationContext(), CustomFont.FONT1);
            CustomFont.markAsIconContainer(findViewById(R.id.getRecord_addContact), mainFont);
        }
        else if(manager.getFontStyle(AddContact_Dynamic.this).equals("pt-sans"))
        {
            Log.e("font","2");
            Typeface mainFont = CustomFont.getTypeface(AddContact_Dynamic.this.getApplicationContext(), CustomFont.FONT2);
            CustomFont.markAsIconContainer(findViewById(R.id.getRecord_addContact), mainFont);
        }
        else if(manager.getFontStyle(AddContact_Dynamic.this).equals("Lora-Regular"))
        {
            Log.e("font","2");
            Typeface mainFont = CustomFont.getTypeface(AddContact_Dynamic.this.getApplicationContext(), CustomFont.FONT3);
            CustomFont.markAsIconContainer(findViewById(R.id.getRecord_addContact), mainFont);
        }
        else if(manager.getFontStyle(AddContact_Dynamic.this).equals("DroidSerif-Regular"))
        {
            Log.e("font","2");
            Typeface mainFont = CustomFont.getTypeface(AddContact_Dynamic.this.getApplicationContext(), CustomFont.FONT4);
            CustomFont.markAsIconContainer(findViewById(R.id.getRecord_addContact), mainFont);
        }
        
        Typeface iconFont = FontManager.getTypeface(getApplicationContext(), FontManager.FONTAWESOME);
        FontManager.markAsIconContainer(findViewById(R.id.addContactLL), iconFont);
        FontManager.markAsIconContainer(findViewById(R.id.addContact_refresh), iconFont);
        FontManager.markAsIconContainer(findViewById(R.id.success_thumb_addContact), iconFont);
        FontManager.markAsIconContainer(findViewById(R.id.change_serach_result_addcontact), iconFont);

        Toolbar toolbar = (Toolbar) findViewById(R.id.addContact_toolbar);
        toolbar.setBackgroundColor(manager.getColor(AddContact_Dynamic.this));

        list=new ArrayList();

        addLeadWarning=(TextView)findViewById(R.id.addContact_warning);
        addMoreRecord=(TextView)findViewById(R.id.AddMoreContact);
        successToast=(TextView)findViewById(R.id.addContact_success_toast);

        addLeadRefresh=(TextView)findViewById(R.id.addContact_refresh);
        ...
        getRecord=(LinearLayout)findViewById(R.id.getRecord_addContact);

        record_id_hidden_addContact=(TextView)findViewById(R.id.record_id_hidden_addContact);

        change_serach_result_addcontact=(TextView)findViewById(R.id.change_serach_result_addcontact);

        partitionName_textview_addContact=(TextView)findViewById(R.id.partitionName_textview_addContact);
        partitionName_textview_addContact.setText(manager.getCustomLabel(AddContact_Dynamic.this,"Record")+" Details");

        accountSearchHint_addContact=(TextInputLayout)findViewById(R.id.accountSearchHint_addContact);
        accountSearchHint_addContact.setHint("Search "+manager.getCustomLabel(AddContact_Dynamic.this,"Banner - Accounts"));

        searchCompany=(AutoCompleteTextView)findViewById(R.id.accountSearch_addContact);
        autoCompleteAdapter = new AutoCompleteAdapter(AddContact_Dynamic.this, android.R.layout.simple_dropdown_item_1line);
        ...
        searchCompany.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            {
                change_serach_result_addcontact.setVisibility(View.VISIBLE);
                ...
                record_id_hidden_addContact.setText(recordId);
            }
        });

        change_serach_result_addcontact.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                change_serach_result_addcontact.setVisibility(View.GONE);
                searchCompany.setText("");
                record_id_hidden_addContact.setText("");
                searchCompany.setEnabled(true);
            }
        });


        addLeadButton=(Button)findViewById(R.id.addContactButton);
        addLeadButton.setText("\tAdd new "+manager.getCustomLabel(AddContact_Dynamic.this,"Banner - Contacts"));
        addLeadButton.setBackgroundColor(manager.getColor(AddContact_Dynamic.this));
...
//                        fieldSpinner[checkSpinner].setFocusable(true);
                ...
                if(record_id_hidden_addContact.getText().toString().equals(""))
                {
                ...
                {
                    Toast.makeText(getApplicationContext(),"Require to select "+manager.getCustomLabel(AddContact_Dynamic.this,"Record"),Toast.LENGTH_LONG).show();
                    getMandatory=0;
                }
                else if(getMandatory==4)
                {
                    Toast.makeText(getApplicationContext(),"Require to select "+manager.getCustomLabel(AddContact_Dynamic.this,"Record")+" from list",Toast.LENGTH_LONG).show();
                    getMandatory=0;
                }
                else
                {
                    Log.e("MapSize",""+fieldKeyValue.size());
                    SaveAddLeadRecords saveAddLeadRecords=new SaveAddLeadRecords(record_id_hidden_addContact.getText().toString());
                    saveAddLeadRecords.execute();
                }
            }
        });

        backButton=(TextView)findViewById(R.id.backBtn_addContact);
        ...
        displayTest1_name=(TextView)findViewById(R.id.addContact_name);
        displayTest1_name.setText("Add new "+manager.getCustomLabel(AddContact_Dynamic.this,"Banner - Contacts"));
        displayTest1_name.setBackgroundColor(manager.getColor(AddContact_Dynamic.this));

        DynamicFieldAdd dynamicFieldAdd=new DynamicFieldAdd();
        dynamicFieldAdd.execute();

        parent=(LinearLayout)findViewById(R.id.addContact_parent);
        successParent=(LinearLayout)findViewById(R.id.success_parent_addContact);
    ...
    private class DynamicFieldAdd extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPreExecute()
        {
            ...
            pd=new ProgressDialog(AddContact_Dynamic.this);
            pd.setMessage("Wait...");
        ...
        protected void onPostExecute(Void aVoid)
        {
            ...
            else
            {
                ...
                {
                    partitionCardView[k] = new LinearLayout(AddContact_Dynamic.this);
//                    partitionCardView[k].setRadius(10);
//                    partitionCardView[k].setCardElevation(20);
//                partitionCardView[k].setPadding(10,10,10,10);
...
//                partitionNameTV[k] = new TextView(AddContact_Dynamic.this);
                    partitionNameTV[k]=new TextView(AddContact_Dynamic.this);
                    ...
                    {
                        partitionNameTV[k].setText(manager.getCustomLabel(AddContact_Dynamic.this,"Contact Information"));
                        checkVisibility=manager.getCustomLabel(AddContact_Dynamic.this,"Contact Information");
                    }
                    else if(unique[k].equals("profile_summary"))
                    {
                        partitionNameTV[k].setText(manager.getCustomLabel(AddContact_Dynamic.this,"Profile Summary"));
                        checkVisibility=manager.getCustomLabel(AddContact_Dynamic.this,"Profile Summary");
                    }
                    else if(unique[k].equals("profile_assignments"))
                    {
                        partitionNameTV[k].setText(manager.getCustomLabel(AddContact_Dynamic.this,"Profile Assignments"));
                        checkVisibility=manager.getCustomLabel(AddContact_Dynamic.this,"Profile Assignments");
                    }
                    else if(unique[k].equals("special_interest_1"))
                    {
                        partitionNameTV[k].setText(manager.getCustomLabel(AddContact_Dynamic.this,"Special Interest"));
                        checkVisibility=manager.getCustomLabel(AddContact_Dynamic.this,"Special Interest");
                    }
                    else if(unique[k].equals("special_interest_2"))
                    {
                        partitionNameTV[k].setText(manager.getCustomLabel(AddContact_Dynamic.this,"Special Interest II"));
                        checkVisibility=manager.getCustomLabel(AddContact_Dynamic.this,"Special Interest II");
                    }
                    else if(unique[k].equals("special_interest_3"))
                    {
                        partitionNameTV[k].setText(manager.getCustomLabel(AddContact_Dynamic.this,"Special Interest III"));
                        checkVisibility=manager.getCustomLabel(AddContact_Dynamic.this,"Special Interest III");
                    }
                    else if(unique[k].equals("sales_comment"))
                    {
                        partitionNameTV[k].setText(manager.getCustomLabel(AddContact_Dynamic.this,"Sales Rep Comments/Notes"));
                        checkVisibility=manager.getCustomLabel(AddContact_Dynamic.this,"Sales Rep Comments/Notes");
                    }
                    ...
                    childContainer[k]=new LinearLayout(AddContact_Dynamic.this);
                    ...
                    for(int i=0;i<list.size();i++)
                    {
                        ...
                        if(testing_data.getFieldType().equals("NONE"))
                        {
                            if(testing_data.getPartitionName().equals(unique[k]))
                            {
                                ...
                                if(testing_data.getFieldDataType().equals("int") || testing_data.getFieldDataType().equals("numeric") || testing_data.getFieldDataType().equals("real"))
                                {
                                    ...
                                    fieldTextInputLayout[indexET] =new TextInputLayout(AddContact_Dynamic.this);
                                    fieldTextInputLayout[indexET].setLayoutParams(params1);
                                    fieldTextInputLayout[indexET].setHint(list.get(i).toString());

                                    fieldET[indexET]=new EditText(AddContact_Dynamic.this);
                                ...
                                else if(testing_data.getFieldDataType().equals("smalldatetime") || testing_data.getFieldDataType().equals("datetime") || testing_data.getFieldDataType().equals("date"))
                                {
                                    ...
                                    fieldET[finalIndexET].setOnClickListener(new View.OnClickListener()
                                    {
                                        ...
                                        public void onClick(View v)
                                        {
                                            ...
                                            datePickerDialog=new DatePickerDialog(AddContact_Dynamic.this, new DatePickerDialog.OnDateSetListener()
                                            {
                                                @Override
                        ...
                        else
                        {
                            if(testing_data.getPartitionName().equals(unique[k]))
                            {
                                ...
                                spinnerTitle[indexSpinner]=new TextView(AddContact_Dynamic.this);
                                ...
                                fieldSpinner[indexSpinner]=new Spinner(AddContact_Dynamic.this);
                                count[indexSpinner]=0;
                                ArrayAdapter<CharSequence> adapter=ArrayAdapter.createFromResource(AddContact_Dynamic.this,
...
//                                        if(fieldSpinner[finalIndexSpinner].getSelectedItem().equals("Select option :"))
                    ...
                    if(manager.getFontStyle(AddContact_Dynamic.this).equals("open-sans"))
                    {
                        ...
                        CustomFont.markAsIconContainer(findViewById(R.id.addContact_name), mainFont);
                    }
                    else if(manager.getFontStyle(AddContact_Dynamic.this).equals("pt-sans"))
                    {
                        Log.e("font","2");
    ...
    private void GetData()
    {
        ...
        try {
            ...
            Request.addProperty("LogonID", manager.getUserId(AddContact_Dynamic.this));
            Request.addProperty("CompanyID", manager.getWG(AddContact_Dynamic.this));
            Request.addProperty("PageName", "addcontact");
    ...
    private class GetSpinnerItems extends AsyncTask<Void,Void,Void>
    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog=new ProgressDialog(AddContact_Dynamic.this);
...
//                    spinnerArray[i] = value;
    ...
    private class SaveAddLeadRecords extends AsyncTask<Void,Void,Void>
    {
        ...
        public SaveAddLeadRecords(String s)
        {
        ...
        protected void onPreExecute()
        {
            ...
            saveRecordProgress = new ProgressDialog(AddContact_Dynamic.this);
        ...
        {
            SoapObject resultRequestSOAP = null;
            String SOAP_ACTION = "LMServiceNamespace/AddContact";
            ...
            {
                SoapObject Request = new SoapObject(NAMESPACE, METHOD_NAME);
                Request.addProperty("logon_id", manager.getUserId(AddContact_Dynamic.this));
                Request.addProperty("pwd", manager.getUserPass(AddContact_Dynamic.this));
                Request.addProperty("company_id", manager.getWG(AddContact_Dynamic.this));

                SoapObject field = new SoapObject(NAMESPACE,"ContactData");
                Request.addSoapObject(field);

                SoapObject record = new SoapObject(NAMESPACE,"TypeContactData");
                Log.e("MapSize",""+fieldKeyValue.size());
...
//                Toast.makeText(getApplicationContext(),"Successfully Record Save",Toast.LENGTH_LONG).show();
                ...
                successToast.setText("Your "+manager.getCustomLabel(AddContact_Dynamic.this,"Banner - Contacts")+"  is successfully add.");
                addMoreRecord.setText("Add More "+manager.getCustomLabel(AddContact_Dynamic.this,"Banner - Contacts"));
            ...
            {
                Toast.makeText(getApplicationContext(),manager.getCustomLabel(AddContact_Dynamic.this,"Banner - Contacts")+" not save,Please try again!",Toast.LENGTH_LONG).show();
            }
        }
    }
