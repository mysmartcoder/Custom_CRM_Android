...
public class MS_Contact_Activity extends Fragment
{
    TextView title;
...
//    EditText searchEdit;
    ...
    MS_Contact_adapter adapter=null;
    ...
    {
        View view = inflater.inflate(R.layout.activity_ms__contact, container, false);
...
//        filterList=new List();
        ...
        lvMSRecords=(ListView)view.findViewById(R.id.mscontact_listview);

        pd=new ProgressDialog(mActivity);

        check=0;

        title=(TextView)view.findViewById(R.id.mscontact_toolbar_title);

        LinearLayout toolbar = (LinearLayout) view.findViewById(R.id.mscon_toolbar);
        toolbar.setBackgroundColor(manager.getColor(getActivity()));

        LinearLayout footer = (LinearLayout) view.findViewById(R.id.mscon_footer);
        ...
        if(manager.getFontStyle(getActivity()).equals("open-sans"))
        {
            ...
            CustomFont.markAsIconContainer(view.findViewById(R.id.mscon_parent), mainFont);
        }
        ...
        totalIndexDisplay=(TextView)view.findViewById(R.id.totalIndex_MSContact);
        startIndexDisplay=(TextView)view.findViewById(R.id.startingIndex_MSContact);
        endIndexDisplay=(TextView)view.findViewById(R.id.endingIndex_MSContact);
        nextBtn=(Button)view.findViewById(R.id.nextBtn_MSContact);
        prevBtn=(Button)view.findViewById(R.id.prevBtn_MSContact);

        adapter=new MS_Contact_adapter(mActivity, list,i,j);
...
//        getSearchAccount.execute();
        ...
        lvMSRecords.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
                final MS_Contact_Data currentListData =adapter.getItem(position);
...
//                intent.putExtra("searchQuery", searchEdit.getText().toString());
        ...
        FontManager.markAsIconContainer(view.findViewById(R.id.icons_container_mscontact), iconFont);
    ...
    private class GetTotalAccount extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            try
            {
                ...
                Request.addProperty("searchType", "contact");
        ...
        protected void onPostExecute(Void aVoid)
        {
            ...
            if(totalRcordDIsplay==0)
            {
                ...
                totalIndexDisplay.setText("Contact not found");
...
//            GetData(i,j);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            {
                lvMSRecords.setAdapter(new MS_Contact_adapter(mActivity, list,i,j));
            }
        }
    }
    ...
    private void GetData()
    {
        ...
        try {
            ...
            for (int i = 0; i < resultRequestSOAP.getPropertyCount(); i++)
            {
                ...
                MS_Contact_Data  callbacktaskData=new MS_Contact_Data();
