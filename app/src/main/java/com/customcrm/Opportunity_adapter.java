...
public class Opportunity_adapter extends BaseAdapter
{
    ...
    public Opportunity_adapter(Context context, ArrayList myList, int i, int j) {
        this.myList = myList;
    ...
    @Override
    public Opportunity_Data getItem(int position) {
        return (Opportunity_Data) myList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            convertView = inflater.inflate(R.layout.raw_opportunity, parent, false);
        ...
        if(manager.getFontStyle(context).equals("open-sans"))
        {
            ...
            CustomFont.markAsIconContainer(convertView.findViewById(R.id.oppAdp_parent), mainFont);
        }
        ...
        FontManager.markAsIconContainer(convertView.findViewById(R.id.icons_container_Opportunity), iconFont);

        final Opportunity_Data currentListData = getItem(position);
...
//                    a.startActivity(intent);
    ...
    private class MyViewHolder
    {
        ...
        {
            tvPolicy = (TextView) item.findViewById(R.id.Opp_policyName);
            tvAcc = (TextView) item.findViewById(R.id.Opp_account);
            tvOpp = (TextView) item.findViewById(R.id.Opp_opportunity);
            tvOpp_Stage=(TextView) item.findViewById(R.id.Opp_opportunityStage);
            tvAcct_mgr=(TextView)item.findViewById(R.id.Opp_acctMgr);
            tvPhone=(TextView)item.findViewById(R.id.Opp_phone);

            opp_tvPolicy = (TextView) item.findViewById(R.id.opp_tvpolicy);
            opp_tvAcc = (TextView) item.findViewById(R.id.opp_tvacc);
            opp_tvOpp = (TextView) item.findViewById(R.id.opp_tvOpp);
            opp_tvOpp_Stage=(TextView) item.findViewById(R.id.opp_tvStage);
            opp_tvAcct_mgr=(TextView)item.findViewById(R.id.opp_tvaccmgr);
            opp_tvPhone=(TextView)item.findViewById(R.id.opp_tvphone);


            assign_Acc_btn=(Button)item.findViewById(R.id.assign_btn_Opp);
            delete_Acc_btn=(Button)item.findViewById(R.id.delete_btn_Opp);
            map_Acc_btn=(Button)item.findViewById(R.id.map_btn_Opp);
            call_Acc_btn=(Button)item.findViewById(R.id.call_btn_Opp);
            select_Acc_btn=(Button)item.findViewById(R.id.select_btn_Opp);
        }
    }
