 ...
 */
public class MS_Case_adapter extends BaseAdapter {
    ...
    public MS_Case_adapter(Context context, ArrayList myList, int i, int j) {
        Log.e("called", "call1");
        this.myList = myList;
...
//        PrepareDrawer.allSet(context);
    ...
    @Override
    public MS_Case_Data getItem(int position) {
        return (MS_Case_Data) myList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.e("called", "call1");
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.raw_mscase, parent, false);
        ...
        if(manager.getFontStyle(context).equals("open-sans"))
        {
            ...
            CustomFont.markAsIconContainer(convertView.findViewById(R.id.mscaseAdp_parent), mainFont);
        }
        ...
        FontManager.markAsIconContainer(convertView.findViewById(R.id.icons_container_MSCase), iconFont);

        final MS_Case_Data currentListData = getItem(position);
...
//                        return;
    ...
    private class MyViewHolder
    {
        ...
        {
            tvEntered = (TextView) item.findViewById(R.id.MSCase_entered);
            tvDateDue = (TextView) item.findViewById(R.id.MSCase_datedue);
            tvCompany = (TextView) item.findViewById(R.id.MSCase_company);
            tvCaseName=(TextView) item.findViewById(R.id.mscase_casename);
            tvCaseStatus=(TextView)item.findViewById(R.id.mscase_status);
            tvCasePriority=(TextView)item.findViewById(R.id.mscase_priority);
            tvCaseOwner=(TextView)item.findViewById(R.id.mscase_owner);
            tvPhone=(TextView)item.findViewById(R.id.mscase_phone);

            case_tvEntered = (TextView) item.findViewById(R.id.mscase_tventered);
            case_tvDateDue = (TextView) item.findViewById(R.id.mscase_tvdatedue);
            case_tvCompany = (TextView) item.findViewById(R.id.mscase_tvcompany);
            case_tvCaseName=(TextView) item.findViewById(R.id.mscase_tvname);
            case_tvCaseStatus=(TextView)item.findViewById(R.id.mscase_tvstatus);
            case_tvCasePriority=(TextView)item.findViewById(R.id.mscase_tvprio);
            case_tvCaseOwner=(TextView)item.findViewById(R.id.mscase_tvowner);
            case_tvPhone=(TextView)item.findViewById(R.id.mscase_tvphone);

            assign_Acc_btn=(Button)item.findViewById(R.id.assign_btn_MSCase);
            delete_Acc_btn=(Button)item.findViewById(R.id.delete_btn_MSCase);
            map_Acc_btn=(Button)item.findViewById(R.id.map_btn_MSCase);
            call_Acc_btn=(Button)item.findViewById(R.id.call_btn_MSCase);
            select_Acc_btn=(Button)item.findViewById(R.id.select_btn_MSCase);
