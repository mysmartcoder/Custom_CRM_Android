...
public class AddOpp_Dynamic extends AppCompatActivity 
{
    ProgressDialog pd;
...
//    HashMap<String,String> spinnerMap;
    ...
    protected void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(R.layout.activity_add_opp_dynamic);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
            ...
            window.setStatusBarColor(manager.getStatusColor(AddOpp_Dynamic.this));
        }

        if(manager.getFontStyle(AddOpp_Dynamic.this).equals("open-sans"))
        {
            Log.e("font","1");
            Typeface mainFont = CustomFont.getTypeface(AddOpp_Dynamic.this.getApplicationContext(), CustomFont.FONT1);
            CustomFont.markAsIconContainer(findViewById(R.id.getRecord_addOpp), mainFont);
        }
        else if(manager.getFontStyle(AddOpp_Dynamic.this).equals("pt-sans"))
        {
            Log.e("font","2");
            Typeface mainFont = CustomFont.getTypeface(AddOpp_Dynamic.this.getApplicationContext(), CustomFont.FONT2);
            CustomFont.markAsIconContainer(findViewById(R.id.getRecord_addOpp), mainFont);
        }
        else if(manager.getFontStyle(AddOpp_Dynamic.this).equals("Lora-Regular"))
        {
            Log.e("font","2");
            Typeface mainFont = CustomFont.getTypeface(AddOpp_Dynamic.this.getApplicationContext(), CustomFont.FONT3);
            CustomFont.markAsIconContainer(findViewById(R.id.getRecord_addOpp), mainFont);
        }
        else if(manager.getFontStyle(AddOpp_Dynamic.this).equals("DroidSerif-Regular"))
        {
            Log.e("font","2");
            Typeface mainFont = CustomFont.getTypeface(AddOpp_Dynamic.this.getApplicationContext(), CustomFont.FONT4);
            CustomFont.markAsIconContainer(findViewById(R.id.getRecord_addOpp), mainFont);
        }
        
        Typeface iconFont = FontManager.getTypeface(getApplicationContext(), FontManager.FONTAWESOME);
        FontManager.markAsIconContainer(findViewById(R.id.addOppLL), iconFont);
        FontManager.markAsIconContainer(findViewById(R.id.addOpp_refresh), iconFont);
        FontManager.markAsIconContainer(findViewById(R.id.success_thumb_addOpp), iconFont);
        FontManager.markAsIconContainer(findViewById(R.id.change_serach_result_addopp), iconFont);

        Toolbar toolbar = (Toolbar) findViewById(R.id.addOpp_toolbar);
        toolbar.setBackgroundColor(manager.getColor(AddOpp_Dynamic.this));

        list=new ArrayList();

        addLeadWarning=(TextView)findViewById(R.id.addOpp_warning);
        addMoreRecord=(TextView)findViewById(R.id.AddMoreOpp);
        successToast=(TextView)findViewById(R.id.addOpp_success_toast);

        addLeadRefresh=(TextView)findViewById(R.id.addOpp_refresh);
        ...
        getRecord=(LinearLayout)findViewById(R.id.getRecord_addOpp);
        partitionName_textview_addOpp=(TextView)findViewById(R.id.partitionName_textview_addOpp);
        change_serach_result_addopp=(TextView)findViewById(R.id.change_serach_result_addopp);
        accountSearchHint_addOpp=(TextInputLayout) findViewById(R.id.accountSearchHint_addOpp);
        key_contact_display=(TextView)findViewById(R.id.key_contact_display_addOpp);
        key_contact_spinner=(Spinner)findViewById(R.id.key_contact_spinner_addOpp);
        searchCompany=(AutoCompleteTextView)findViewById(R.id.accountSearch_addOpp);
        record_id_hidden_addOpp=(TextView)findViewById(R.id.record_id_hidden_addOpp);
        key_contact_restriction_addOpp=(TextView)findViewById(R.id.key_contact_restriction_addOpp);
        key_contact_fieldId_addOpp=(TextView)findViewById(R.id.key_contact_fieldId_addOpp);

        partitionName_textview_addOpp.setText(manager.getCustomLabel(AddOpp_Dynamic.this,"Record")+" Details");
        accountSearchHint_addOpp.setHint("Search "+manager.getCustomLabel(AddOpp_Dynamic.this,"Banner - Accounts"));

        autoCompleteAdapter = new AutoCompleteAdapter(AddOpp_Dynamic.this, android.R.layout.simple_dropdown_item_1line);
        ...
        addLeadButton=(Button)findViewById(R.id.addOppButton);
        addLeadButton.setText("\tAdd new "+manager.getCustomLabel(AddOpp_Dynamic.this,"Opportunity"));
        addLeadButton.setBackgroundColor(manager.getColor(AddOpp_Dynamic.this));
...
//                if(spinnerMap.get(fieldSpinner[j].getSelectedItem().toString())== null && spinnerRestriction[j].getText().toString().equals("true"))
                ...
                {
                    Toast.makeText(getApplicationContext(),"Require to select "+manager.getCustomLabel(AddOpp_Dynamic.this,"Record"),Toast.LENGTH_LONG).show();
                    getMandatory=0;
                }
                else if(getMandatory==4)
                {
                    Toast.makeText(getApplicationContext(),"Require to select "+manager.getCustomLabel(AddOpp_Dynamic.this,"Record")+" from list",Toast.LENGTH_LONG).show();
                    getMandatory=0;
                }
                else
                {
                    SaveAddOppRecords saveAddOppRecords=new SaveAddOppRecords(record_id_hidden_addOpp.getText().toString());
                    saveAddOppRecords.execute();
                }
            }
        });

        backButton=(TextView)findViewById(R.id.backBtn_addOpp);
        ...
        displayTest1_name=(TextView)findViewById(R.id.addOpp_name);
        displayTest1_name.setText("Add new "+manager.getCustomLabel(AddOpp_Dynamic.this,"Opportunity"));
        displayTest1_name.setBackgroundColor(manager.getColor(AddOpp_Dynamic.this));

        DynamicFieldAdd dynamicFieldAdd=new DynamicFieldAdd();
        dynamicFieldAdd.execute();

        parent=(LinearLayout)findViewById(R.id.addOpp_parent);
        successParent=(LinearLayout)findViewById(R.id.success_parent_addOpp);
    ...
    private class DynamicFieldAdd extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPreExecute()
        {
            ...
            pd=new ProgressDialog(AddOpp_Dynamic.this);
            pd.setMessage("Wait...");
        ...
        protected void onPostExecute(Void aVoid)
        {
            ...
            else
            {
                ...
                {
                    partitionCardView[k] = new LinearLayout(AddOpp_Dynamic.this);
...
//                partitionNameTV[k] = new TextView(AddOpp_Dynamic.this);
                    partitionNameTV[k]=new TextView(AddOpp_Dynamic.this);
                    ...
                    if(unique[k].equals("details"))
                    {
                        partitionNameTV[k].setText(manager.getCustomLabel(AddOpp_Dynamic.this,"Opportunity Details"));
                        checkVisibility=manager.getCustomLabel(AddOpp_Dynamic.this,"Opportunity Details");
                    }
                    else if(unique[k].equals("products"))
                    {
                        partitionNameTV[k].setText(manager.getCustomLabel(AddOpp_Dynamic.this,"Product Details"));
                        checkVisibility=manager.getCustomLabel(AddOpp_Dynamic.this,"Product Details");
                    }
                    ...
                    childContainer[k]=new LinearLayout(AddOpp_Dynamic.this);
                        ...
                        if(! testing_data.getFieldID().equals("ContactID"))
                        {
                            if(testing_data.getFieldType().equals("NONE"))
                            {
                                ...
                                /**/
                                    ...
                                    if(testing_data.getFieldDataType().equals("int") || testing_data.getFieldDataType().equals("numeric") || testing_data.getFieldDataType().equals("real"))
                                    {
                                        ...
                                        fieldTextInputLayout[indexET] =new TextInputLayout(AddOpp_Dynamic.this);
                                        fieldTextInputLayout[indexET].setLayoutParams(params1);
                                        fieldTextInputLayout[indexET].setHint(list.get(i).toString());

                                        fieldET[indexET]=new EditText(AddOpp_Dynamic.this);
                                    ...
                                    else if(testing_data.getFieldDataType().equals("smalldatetime") || testing_data.getFieldDataType().equals("datetime") || testing_data.getFieldDataType().equals("date"))
                                    {
                                        ...
                                        fieldET[finalIndexET].setOnClickListener(new View.OnClickListener()
                                        {
                                            ...
                                            public void onClick(View v)
                                            {
                                                ...
                                                datePickerDialog=new DatePickerDialog(AddOpp_Dynamic.this, new DatePickerDialog.OnDateSetListener()
                                                {
                                                    @Override
                            ...
                            else
                            {
                                if(testing_data.getPartitionName().equals(unique[k]))
                                {
                                    ...
                                    spinnerTitle[indexSpinner]=new TextView(AddOpp_Dynamic.this);
                                ...
                                /**/
                                    ...
                                    fieldSpinner[indexSpinner]=new Spinner(AddOpp_Dynamic.this);
                                    count[indexSpinner]=0;
                                    ArrayAdapter<CharSequence> adapter=ArrayAdapter.createFromResource(AddOpp_Dynamic.this,
...
//                            key_contact_display.setPaintFlags(key_contact_display.getPaintFlags()| Paint.UNDERLINE_TEXT_FLAG);
                    ...
                    if(manager.getFontStyle(AddOpp_Dynamic.this).equals("open-sans"))
                    {
                        ...
                        CustomFont.markAsIconContainer(findViewById(R.id.addOpp_name), mainFont);
                    }
                    else if(manager.getFontStyle(AddOpp_Dynamic.this).equals("pt-sans"))
                    {
                        Log.e("font","2");
    ...
    private void GetData()
    {
        ...
        try {
            ...
            Request.addProperty("LogonID", manager.getUserId(AddOpp_Dynamic.this));
            Request.addProperty("CompanyID", manager.getWG(AddOpp_Dynamic.this));
            Request.addProperty("PageName", "addopp");
    ...
    private class GetSpinnerItems extends AsyncTask<Void,Void,Void>
    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog=new ProgressDialog(AddOpp_Dynamic.this);
...
//                    spinnerArray[i] = value;
    ...
    private class SaveAddOppRecords extends AsyncTask<Void,Void,Void>
    {
        ProgressDialog saveRecordProgress;
        int countResponse=0;
        int recordId;

        public SaveAddOppRecords(String s)
        {
        ...
        protected void onPreExecute()
        {
            ...
            saveRecordProgress = new ProgressDialog(AddOpp_Dynamic.this);
        ...
        {
            SoapObject resultRequestSOAP = null;
            String SOAP_ACTION = "LMServiceNamespace/AddOpportunity";
            String METHOD_NAME = "AddOpportunity";
            String NAMESPACE = "LMServiceNamespace";
            String URL = manager.getUrl();
            ...
            {
                SoapObject Request = new SoapObject(NAMESPACE, METHOD_NAME);
                Request.addProperty("logon_id", manager.getUserId(AddOpp_Dynamic.this));
                Request.addProperty("pwd", manager.getUserPass(AddOpp_Dynamic.this));
                Request.addProperty("company_id", manager.getWG(AddOpp_Dynamic.this));

                SoapObject field = new SoapObject(NAMESPACE,"OpportunityData");
                Request.addSoapObject(field);

                SoapObject record = new SoapObject(NAMESPACE,"TypeOpportunityData");
                ...
                {
                    SoapObject TypeEventData = (SoapObject) resultRequestSOAP .getProperty(i);
                    String oppID = TypeEventData.getProperty("OppID").toString();
                    Log.e("OppID:",oppID);
                }
                Log.e("00000000", "Result SECOND API: " + resultRequestSOAP);
            }
...
//                Toast.makeText(getApplicationContext(),"Successfully Record Save",Toast.LENGTH_LONG).show();
                ...
                successToast.setText("Your "+manager.getCustomLabel(AddOpp_Dynamic.this,"Opportunity")+"  is successfully add.");
                addMoreRecord.setText("Add More "+manager.getCustomLabel(AddOpp_Dynamic.this,"Opportunity"));
            ...
            {
                Toast.makeText(getApplicationContext(),manager.getCustomLabel(AddOpp_Dynamic.this,"Opportunity")+" not save,Please try again!",Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private class GetKeyContact extends AsyncTask<Void,Void,Void>
    {
        ...
        protected void onPreExecute()
        {
            ...
            keyContactPd=new ProgressDialog(AddOpp_Dynamic.this);
